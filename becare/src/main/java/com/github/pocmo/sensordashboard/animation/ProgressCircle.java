package com.github.pocmo.sensordashboard.animation;
...
/**
 * Created by neerajpaliwal on 10/11/16.
 */
public class ProgressCircle extends View {
    ...
    public ProgressCircle(Context context, AttributeSet attrs) {
        ...
        try {
            textColor = a.getColor(R.styleable.ProgressCircle_android_textColor, R.color.progress_circle_textcolor);
            ...
            progressColor = a.getColor(R.styleable.ProgressCircle_progressColor, R.color.progress_circle_fill);
            incompleteColor = a.getColor(R.styleable.ProgressCircle_incompleteProgressColor, R.color.progress_circle_unfill);
        } finally {
            a.recycle();
        }
...
//        icon = BitmapFactory.decodeResource(getResources(), R.drawable.ic_placeholder);
    ...
    public void startAnimation(int duration) {
        ProgressCircle.this.mSweepAngle = 0;
