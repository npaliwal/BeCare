...
public class PreferenceStorage {
    ...
    private static final String USER_NAME = "becare_user_name";
    private static final String USER_EMAIL = "becare_user_email";
    private static final String USER_TOKEN = "becare_user_token";
    ...
    public String getUserName() {
        return sharedPreferences.getString(PreferenceStorage.USER_NAME, "User");
    }

    public void setUserInfo(String name, String emailId) {
        editor.putString(PreferenceStorage.USER_NAME, name).commit();
        editor.putString(PreferenceStorage.USER_EMAIL, emailId).commit();
    }
