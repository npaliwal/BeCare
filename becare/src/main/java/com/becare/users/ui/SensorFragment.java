...
import com.becare.users.data.DataEntry;
...
import com.becare.users.events.SensorRangeEvent;
import com.becare.users.events.SensorUpdatedEvent;
import com.becare.users.events.TagAddedEvent;
...
public class SensorFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        sensor = BecareRemoteSensorManager.getInstance(getActivity()).getSensor(sensorId);
    ...
    private void initialiseSensorData() {
        ...
        this.sensorview.setNormalisedDataPoints(normalisedValues, accuracyValues, timestampValues, BecareRemoteSensorManager.getInstance(getActivity()).getTags());
